...
<html>
    ...
    <body class="body-inscription">
        ...
        <francais><a href="inscriptionEntreprise.php" class="lien_connexion" style="color:black">Vous inscrire en tant qu'entreprise</a></francais>
        <anglais><a href="inscriptionEntreprise.php" class="lien_connexion" style="color:black">Register as a company</a></anglais>

        <p id="inscription-entreprise">Inscription</p>

        <form action="../controleur/inscriptionUserbis.php" method="POST" name="inscription"> 
